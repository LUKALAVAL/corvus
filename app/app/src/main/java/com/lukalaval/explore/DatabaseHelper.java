...
// This helper class contains methods for opening and retrieving SQLite databases.
// It also allows the app developer provides a database containing data to be used within the app.
public class DatabaseHelper extends SQLiteOpenHelper {
    private static String DB_PATH;
    private static String DB_PATH_PREFIX = "/data/user/0/";
    private static String DB_PATH_SUFFIX = "/databases/";
    private static String DB_NAME = "explore.db";
